...
| `brigade up` | Run the Analyst, Examiner, Builder, and Designer workers as foreground tasks. |
| `brigade status` | Show inbox depths and project state. |
| `brigade down` | Stop workers (stub — workers run in the foreground for now). |
